...
{
    public partial class frmEng : Form
    {
        public frmEng()
        {
            InitializeComponent();
   ...
   : cmbFrom.Text;
    ...
    : cmbType.Text;
            ...
            else if (TType == "4")
            {
                ...
                {
                    lblPrice.Text = "5.00";
                    spreader.SpeakAsync(" ticket price is 5 rupees");
                }
            }
            else
            {
        ...
        {
            spreader.SpeakAsync("Please, Select the start point, End point, Type of class and Type of train. Then you can see the ticket price");
        }
