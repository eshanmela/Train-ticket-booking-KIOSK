...
{
    public partial class frmSinPay : Form
    {
        ...
        {
            this.Hide();
            frmSelect frmSinSe = new frmSelect();
            frmSinSe.Show();
        }

        double Price;

        private void frmSinPay_Load(object sender, EventArgs e)
        {
            lblPrice.Text = En1.ToString();
            Price = Convert.ToDouble(En1);
            spreader.SpeakAsync("ithuru labagatha nohaka");
        ...
        private void btnPay_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ප්‍රමාණවත් මුදළක් ඇතුලත්කර නොමැත. ");
                byte inhibit = 0x01;
                comThread.Suspend();
                ComDll.SetInhibit(buffer, inhibit);
                length = (int)buffer[1];
        ...
        private void lblInse_Click(object sender, EventArgs e)
        {

        }

        private void lblInse_TextChanged(object sender, EventArgs e)
        {
            amount = Convert.ToDouble(Global.total);
